...
namespace KooFrame.BaseSystem
{
	public static class KooFrameInstance
	{
		...
		public static void CreateFoldsByUseModel()
		{
			//创建美术资源文件夹
			KooFileTool.CreateDirectory("Assets/0.GameArts");
			//创建游戏逻辑主体文件夹
			KooFileTool.CreateDirectory("Assets/1.GameBuild");
			//创建游戏子系统文件夹
			KooFileTool.CreateDirectory("Assets/2.SubSystem");
